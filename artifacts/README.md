...
Do not publish the final `stage0-full51-v1` folder until both Part A and Part B
pass independent local SHA-256 verification. Use a `-staging` suffix during
upload and keep ordinary teammate access read-only.
