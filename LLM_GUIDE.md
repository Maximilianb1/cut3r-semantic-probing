...
1. Read `data_pipeline/README.md`, `data_pipeline/PROJECT_STATUS.md`, and `data_pipeline/CONTRIBUTING.md`. New segmentation-validation work lives under `segmentation_validation/`.
